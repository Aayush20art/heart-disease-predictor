...
The application takes several health-related inputs from the user and uses a trained model to determine whether the patient has a high risk or low risk of heart disease.
...
Aayush Sharma
B.Tech Final Year Student | Aspiring Data Scientist
